...
const styles = require('../styles/components/logo-cmp.scss');

const Logo = () => (
    <h1 className={styles['root']} itemScope="http://schema.org/Organization" itemType="">
        <a href="/index.php?page=accueil" itemProp="url" title="Retour à l'accueil">
            ...
            {((ie.version && ie.version > 8) || !ie.version) && (
                <img alt="Site d'actualité le Point" height="86" itemProp="logo" src={SvgLogo} width="196" />
            )}
            {((ie.version && ie.version > 8) || !ie.version) && (
        ...
        <span content="https://www.linkedin.com/company/le-point" itemProp="sameas" />
    </h1>
);
