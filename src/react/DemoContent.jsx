...
const styles = require('../styles/components/demo-content.scss');

console.log('DemoContent - styles: ', styles);
...
export default class DemoContent extends Component {
    static handleClick(ev) {
        ...
        import('../modules/video')
            ...
            .catch(err => {
                document.getElementById('video-container').innerHTML = "Error, Couldn' load the video!";
                // logging the error
                console.error(err);
            });
    }
