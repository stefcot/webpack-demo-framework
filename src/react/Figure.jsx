...
const styles = require('../styles/components/figure-cmp.scss');
...
class Figure extends React.Component {
    ...
    render() {
        const { index, contentPath, imgPath, alt, width, height, legend, isPremium, icon } = this.props;
        ...
        return (
            <figure className={classes} id={index}>
                ...
                {typeof legend !== 'undefined' && legend !== '' && <figcaption>{legend}</figcaption>}
            </figure>
        );
    }
}
